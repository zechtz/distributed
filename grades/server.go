...
// RegisterHandlers registers all possible handles for students service
...
// /students - entrire class
// /students/{id} - a single student record
// /students/{id}/grades - a single student grade
